...
<div class="pageHeader">
	...
	<form onsubmit="return navTabSearch(this);" action="method!dingdanlist" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="method!dingdanadd" target="dialog" mask="true"><span>添加订单</span></a></li>
			<li><a class="delete" href="method!dingdandelete?id={sid_user}" target="ajaxTodo" title="确定要删除吗?" ><span>删除订单</span></a></li>
			<li><a class="edit" href="method!dingdanupdate?id={sid_user}" target="dialog" mask="true"><span>修改订单</span></a></li>
